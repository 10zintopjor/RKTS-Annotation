            ...
            if 'imgnum' in paginations[uuid]:
                ...
                if paginations[uuid]['page_info'] != None:
                    new_pagination[f"{uuid}"] = { 
                        ...
                        'pagination':paginations[uuid]['page_index']
                    }
...
def download_pecha(pecha_id, out_path=None, branch="master"):
    pecha_url = f"https://github.com/jungtop/P000006.git"
...
if __name__=='__main__':
    token = "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"
    g = Github(token) 
